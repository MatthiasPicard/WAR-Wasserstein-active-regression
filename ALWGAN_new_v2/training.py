...
from ALWGAN_new_v2.dataset_handler import myData,WA_myData
...
class WAAL:
    ...
    def query(self):
        ...
        total_scores = (1/(self.num_elem_queried+len(np.arange(self.n_pool)[self.idx_lb]))) * (losses - phi_scores.detach().numpy())   # removed csts
