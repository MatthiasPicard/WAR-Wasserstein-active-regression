...
from ALWGAN_new_v5.Experiment_functions import display_phi
from ALWGAN_new_v5.dataset_handler import myData
...
class WAAL:
    ...
    def train(self,show_losses,early_stopper,val_proportion):
        ...
        for epoch in range(self.total_epoch_h):
            ...
            for i,data in enumerate(trainloader_labelled_h,0):
                ...
                if threshhold_val>=5 and early_stopper.early_stop_method=="validation":
                    ...
                    val_h_descent=t1_cnst*torch.sum(self.abs_cost_func(val_lb_out,val_label_y))
        ...
        for epoch in range(self.total_epoch_phi):  
            ...
            for i in range(nb_batch):
                ...
                #print(len(label_x),len(unlabel_x))
    ...
    def query(self,reduced,cnst_t3phi):
